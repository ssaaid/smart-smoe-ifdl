...
const processes = [
  {
    ...
    responsable: 'Pr. ARAICHI Rachid — Directeur ESEF',
    description: "Assurer le pilotage strategique, la gouvernance du SMOE et garantir la definition des orientations qualite, la planification, le suivi de la performance et l'amelioration continue du Master IFDL.",
    objectifs: "Garantir l'efficacite, la pertinence et l'amelioration continue du SMOE en orientant les decisions strategiques conformement aux exigences de la norme ISO 21001 et aux orientations institutionnelles marocaines.",
    inputs: ['Vision strategique UH1', 'Exigences ISO 21001:2018', 'Besoins des parties interessees', 'Resultats des audits internes', 'Donnees KPI et enquetes'],
    outputs: ['Politique qualite validee', 'Objectifs qualite definis', "Plan d'action SMOE", 'Rapport de revue de direction', "Plans d'amelioration"],
    kpis: [
      { code: 'KPI-01', libelle: "Taux d'atteinte des objectifs qualite", valeur: 87, cible: 85, unite: '%' },
      { code: 'KPI-02', libelle: 'Taux de mise en oeuvre des decisions de revue', valeur: 82, cible: 85, unite: '%' },
      { code: 'KPI-03', libelle: "Taux d'efficacite des actions correctives", valeur: 85, cible: 85, unite: '%' },
    ],
    nb_documents: 7, nb_risques: 3, performance: 85, couleur: 'blue',
  },
  {
    id: 'PR-02', code: 'PR-02', libelle: 'Realisation Pedagogique', type: 'realisation',
    responsable: 'Pr. Soumiya TAMANI — Coordonnatrice Master IFDL',
    description: "Assurer la conception, l'organisation, la realisation, l'evaluation et la certification de la formation du Master IFDL. Gestion des parcours, modules, enseignements, stages et suivi des laureats.",
    objectifs: "Garantir une formation de qualite permettant le developpement des competences, l'atteinte des resultats d'apprentissage et la delivrance de diplomes conformes aux referentiels nationaux.",
    inputs: ['Besoins marche et parties interessees', 'Referentiels pedagogiques CNPN', 'Dossiers de candidature', 'Exigences qualite ISO 21001'],
    outputs: ['Diplomes et competences certifiees', "Resultats d'apprentissage", 'Rapports pedagogiques', 'Indicateurs de performance'],
    kpis: [
      { code: 'KPI-04', libelle: 'Taux de reussite des etudiants', valeur: 91, cible: 85, unite: '%' },
      { code: 'KPI-05', libelle: 'Taux de satisfaction des etudiants', valeur: 78, cible: 85, unite: '%' },
      { code: 'KPI-06', libelle: "Taux d'insertion professionnelle (6 mois)", valeur: 74, cible: 70, unite: '%' },
      { code: 'KPI-07', libelle: 'Taux de diplomation', valeur: 88, cible: 80, unite: '%' },
    ],
    nb_documents: 9, nb_risques: 2, performance: 91, couleur: 'green',
  },
  {
    id: 'PR-03', code: 'PR-03', libelle: 'Support et Ressources', type: 'support',
    responsable: 'Secretaire General ESEF Berrechid',
    description: "Fournir les ressources humaines, techniques, administratives, financieres et logistiques necessaires au bon fonctionnement du Master IFDL. Gestion des SI, scolarite, RH et infrastructures.",
    objectifs: "Garantir la disponibilite et la qualite des ressources et services permettant aux processus de realisation et de pilotage d'atteindre leurs objectifs institutionnels.",
    inputs: ['Besoins pedagogiques et administratifs', 'Ressources institutionnelles allouees', 'Demandes des parties interessees'],
    outputs: ['Services administratifs de qualite', 'Support numerique operationnel (Moodle, APOGEE)', 'Ressources humaines competentes'],
    kpis: [
      { code: 'KPI-08', libelle: 'Taux de disponibilite des SI', valeur: 96, cible: 95, unite: '%' },
      { code: 'KPI-09', libelle: '% enseignants formes', valeur: 76, cible: 80, unite: '%' },
      { code: 'KPI-10', libelle: "Taux d'execution budgetaire", valeur: 92, cible: 90, unite: '%' },
    ],
    nb_documents: 6, nb_risques: 2, performance: 88, couleur: 'purple',
  },
  {
    id: 'PR-04', code: 'PR-04', libelle: 'Evaluation et Amelioration', type: 'support',
    responsable: 'Responsable Qualite SMOE',
    description: "Assurer l'evaluation continue de la performance du SMOE, mesurer l'efficacite des processus et piloter les actions d'amelioration continue conformement a ISO 21001.",
    objectifs: "Garantir la surveillance, l'analyse, l'evaluation et l'amelioration continue du SMOE conformement aux exigences de la norme ISO 21001 et preparer la certification.",
    inputs: ['Resultats des KPI processus', "Rapports d'audit interne", 'Reclamations parties interessees', 'NC identifiees'],
    outputs: ['Rapports de performance', "Plans d'action correctifs", "Recommandations d'amelioration", 'Processus et procedures mis a jour'],
    kpis: [
      { code: 'KPI-11', libelle: 'Taux de realisation des audits', valeur: 100, cible: 90, unite: '%' },
      { code: 'KPI-12', libelle: 'Taux de traitement des NC', valeur: 71, cible: 95, unite: '%' },
      { code: 'KPI-13', libelle: 'Taux de satisfaction parties interessees', valeur: 78, cible: 85, unite: '%' },
    ],
    nb_documents: 5, nb_risques: 1, performance: 75, couleur: 'orange',
  },
];
